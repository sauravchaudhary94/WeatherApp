...
namespace WeatherAppTest
{
    public static class MockForms
    {
        public static void Init()
        {
            ...
            mockPlatformServices.RuntimePlatform = Device.iOS;
            Device.PlatformServices = (Xamarin.Forms.Internals.IPlatformServices)mockPlatformServices;

            DependencyService.Register<IConfigurationManager, ConfigurationManager>();
            DependencyService.Register<IConfigurationManager, MockConfigurationManager>();
        ...
        internal class MockDeserializer : IDeserializer
        {
            ...
            Task<IDictionary<string, object>> IDeserializer.DeserializePropertiesAsync()
            {
                throw new NotImplementedException();
            }
        }
        ...
        public class ApplicationMock : Application
        {
            ...
            {
                var navigation = A.Fake<INavigation>();
